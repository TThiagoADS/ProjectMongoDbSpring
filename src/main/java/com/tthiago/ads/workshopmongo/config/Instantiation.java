...
import com.tthiago.ads.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null,sdf.parse("23/03/2018"),"acordei feliz","hoje estou muito feliz", new AuthorDTO(maria));
		
		CommentDTO c1 = new CommentDTO("Boa viagem brother!",sdf.parse("21/03/2018"), new AuthorDTO(alex));
